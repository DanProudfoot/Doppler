	...
	render: function render() {
		...
		return React.createElement(
			...
			this.state.song.map(function (song) {
				return React.createElement(
					"div",
					{ className: "album album-dark" },
					React.createElement(
						"div",
						{ className: "album_image" },
						React.createElement("img", { src: _this.urlPath + song.artPath, alt: "" })
					),
					React.createElement(
						"div",
...
},{"./stores/songStore.js":181,"react":156,"reflux":157,"superagent":177}],2:[function(require,module,exports){
/**
...
var songStore = Reflux.createStore({
	...
	init: function init() {
		var _this = this;
		request("http://46.101.0.118:3610/api/v1/Songs", function (err, res) {
...
},{"react":156,"reflux":157,"superagent":177}]},{},[1]);
